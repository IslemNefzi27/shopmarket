    ...
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 text-white mb-6 relative overflow-hidden">
        ...
        <div class="relative flex flex-col sm:flex-row items-center gap-6">
            ...
            <div class="text-center sm:text-left">
                ...
                <p class="text-white/80"><?php echo e($user->email); ?></p>
                <?php if($user->bio): ?>
                    <p class="text-white/70 text-sm mt-2 max-w-md"><?php echo e($user->bio); ?></p>
                <?php endif; ?>
                <div class="flex items-center gap-4 mt-3 justify-center sm:justify-start">
                    <span class="text-sm bg-white/20 px-3 py-1 rounded-full">
                        <i class="fas fa-box mr-1"></i> <?php echo e($user->products->count()); ?> produits
                    </span>
                    <span class="text-sm bg-white/20 px-3 py-1 rounded-full">
                        <i class="fas fa-receipt mr-1"></i> <?php echo e($user->orders->count()); ?> commandes
                    </span>
                    <span class="text-sm bg-white/20 px-3 py-1 rounded-full">
                        <i class="fas fa-star mr-1"></i> <?php echo e($user->reviews->count()); ?> avis
                    </span>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('profile.edit')); ?>" class="text-sm text-indigo-600 hover:underline sm:hidden">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-800"><?php echo e($user->email); ?>
                ...
                <?php if($user->phone): ?>
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-800"><?php echo e($user->phone); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                <?php if($user->address): ?>
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-800"><?php echo e($user->address); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-800"><?php echo e($user->created_at->format('d/m/Y')); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="grid grid-cols-2 gap-3">
                <a href="<?php echo e(route('products.my')); ?>"
                    ...
                    <span class="text-xs text-indigo-400"><?php echo e($user->products->count()); ?></span>
                </a>
                <a href="<?php echo e(route('orders.index')); ?>"
                    ...
                    <span class="text-xs text-green-400"><?php echo e($user->orders->count()); ?></span>
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\shopmarket\resources\views/profile/show.blade.php ENDPATH**/ ?>